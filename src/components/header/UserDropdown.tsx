...
const handleProfile = () => {
 ...
 const fetchUserData = async () => {
  try {
    ...
    // Employee list fetch
    const response = await axios.get('https://api.erp.pssoft.xyz/api/v1/hr/employees');
    ...
    if (matchedUser) {
      ...
      console.log("No employee matched localStorage email");
    }
        ...
        <span className="mr-3 overflow-hidden rounded-full h-11 w-11">
          <img 
            ...
            onError={(e) => {
              ...
              target.src = "https://i.postimg.cc/kG1Byx5n/photo-1740252117044-2af197eea287.avif";
            }}
          />
        </span>
